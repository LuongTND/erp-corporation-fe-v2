...
export function EmployeeListToolbar({ total, shown, search, onSearchChange, onExport, isExporting }: EmployeeListToolbarProps) {
  return (
      ...
      <div className="flex items-center gap-2">
        ...
        {onExport && (
          <button
            ...
            className="flex h-10 cursor-pointer items-center gap-1.5 rounded-md border border-border bg-card px-3 text-sm text-foreground transition-colors hover:bg-muted/50 disabled:cursor-wait disabled:opacity-60"
          >
