    ...
    <Sheet open={isOpen} onOpenChange={(open) => !open && handleSheetClose()}>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-3">
          ...
          <TaskSheetAttachments taskId={task?.id ?? ''} />

          <div className="my-4" style={{ height: '0.5px', backgroundColor: '#e6dfd8' }} />

          <TaskSheetDependencies taskId={task?.id ?? ''} />

          <div className="my-4" style={{ height: '0.5px', backgroundColor: '#e6dfd8' }} />

          <TaskSheetCustomProperties taskId={task?.id ?? ''} />

          <div className="my-4" style={{ height: '0.5px', backgroundColor: '#e6dfd8' }} />

          <TaskSheetComments taskId={task?.id as string} />

          <div className="my-4" style={{ height: '0.5px', backgroundColor: '#e6dfd8' }} />

          <TaskSheetActivityLog taskId={task?.id ?? ''} />
        </div>
      </SheetContent>
    </Sheet>
  )
